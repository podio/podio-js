(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['lodash', 'URIjs', 'superagent', 'es6-promise'], factory);
  } else if (typeof exports === 'object') {
    module.exports = factory(require('lodash'), require('URIjs'), require('superagent'), require('es6-promise'));
  } else {
  ...
  var AuthLib = {
    ...
    _hasClientSideRedirect: function() {
      ...
      if (this.authType !== 'client') {
        ...
        params = this.utils._getHashParams();
        ...
        case 401:
          if (response.body.error === 'invalid_token' || response.body.error_description === 'expired_token') {
            if (this.authObject.refreshToken) {
              ...
              this._refreshToken(this.request.bind(this, request.method, request.path, request.data, options.callback, resolveRejectOptions));
            } else {
