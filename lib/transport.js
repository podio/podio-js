...
module.exports = {
  ...
  trustedRequest: function(method, path, data, callback, options) {
    var url = new URI(this.apiURL).path(path).toString();
    var auth = 'Basic ' + new Buffer(this.clientId + ':' + this.clientSecret).toString('base64');
    var req = request[method](url);

    req = _.compose(this._addRequestData.bind(this, data, method), this._addCORS.bind(this), this._setOptions.bind(this, options || {}))(req);
